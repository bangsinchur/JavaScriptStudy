...
//   const response = fetch('https://learn.codeit.kr/api/menus').then(response => {
...
// const menuPromise = responsePromise.then(reponse =>{
//     return reponse.json();
// })
...
fetch('https://learn.codeit.kr/api/menus').then(reponse => reponse.json()).then(menus =>{
    const randomMenu = getRandomElement(menus);
    console.log(`오늘의 랜덤 메뉴는 ${randomMenu.name}입니다!`)
})